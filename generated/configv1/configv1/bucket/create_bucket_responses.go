...
func (o *CreateBucketOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/buckets][%d] createBucketOK %s", 200, payload)
}
...
func (o *CreateBucketBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/buckets][%d] createBucketBadRequest %s", 400, payload)
}
...
func (o *CreateBucketConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/buckets][%d] createBucketConflict %s", 409, payload)
}
...
func (o *CreateBucketInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/buckets][%d] createBucketInternalServerError %s", 500, payload)
}
...
func (o *CreateBucketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/buckets][%d] CreateBucket default %s", o._statusCode, payload)
}
