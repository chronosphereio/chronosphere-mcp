...
func (o *DeleteBucketOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/buckets/{slug}][%d] deleteBucketOK %s", 200, payload)
}
...
func (o *DeleteBucketBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/buckets/{slug}][%d] deleteBucketBadRequest %s", 400, payload)
}
...
func (o *DeleteBucketNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/buckets/{slug}][%d] deleteBucketNotFound %s", 404, payload)
}
...
func (o *DeleteBucketInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/buckets/{slug}][%d] deleteBucketInternalServerError %s", 500, payload)
}
...
func (o *DeleteBucketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/buckets/{slug}][%d] DeleteBucket default %s", o._statusCode, payload)
}
