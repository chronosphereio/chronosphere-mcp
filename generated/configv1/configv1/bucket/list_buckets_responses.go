...
func (o *ListBucketsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/buckets][%d] listBucketsOK %s", 200, payload)
}
...
func (o *ListBucketsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/buckets][%d] listBucketsInternalServerError %s", 500, payload)
}
...
func (o *ListBucketsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/buckets][%d] ListBuckets default %s", o._statusCode, payload)
}
