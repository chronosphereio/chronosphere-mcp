...
func (o *ReadBucketOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/buckets/{slug}][%d] readBucketOK %s", 200, payload)
}
...
func (o *ReadBucketNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/buckets/{slug}][%d] readBucketNotFound %s", 404, payload)
}
...
func (o *ReadBucketInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/buckets/{slug}][%d] readBucketInternalServerError %s", 500, payload)
}
...
func (o *ReadBucketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/buckets/{slug}][%d] ReadBucket default %s", o._statusCode, payload)
}
