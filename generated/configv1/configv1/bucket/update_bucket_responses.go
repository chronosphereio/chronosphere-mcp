...
func (o *UpdateBucketOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] updateBucketOK %s", 200, payload)
}
...
func (o *UpdateBucketBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] updateBucketBadRequest %s", 400, payload)
}
...
func (o *UpdateBucketNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] updateBucketNotFound %s", 404, payload)
}
...
func (o *UpdateBucketConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] updateBucketConflict %s", 409, payload)
}
...
func (o *UpdateBucketInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] updateBucketInternalServerError %s", 500, payload)
}
...
func (o *UpdateBucketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/buckets/{slug}][%d] UpdateBucket default %s", o._statusCode, payload)
}
