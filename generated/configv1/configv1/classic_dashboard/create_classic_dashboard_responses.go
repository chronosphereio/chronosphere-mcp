...
func (o *CreateClassicDashboardOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/classic-dashboards][%d] createClassicDashboardOK %s", 200, payload)
}
...
func (o *CreateClassicDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/classic-dashboards][%d] createClassicDashboardBadRequest %s", 400, payload)
}
...
func (o *CreateClassicDashboardConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/classic-dashboards][%d] createClassicDashboardConflict %s", 409, payload)
}
...
func (o *CreateClassicDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/classic-dashboards][%d] createClassicDashboardInternalServerError %s", 500, payload)
}
...
func (o *CreateClassicDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/classic-dashboards][%d] CreateClassicDashboard default %s", o._statusCode, payload)
}
