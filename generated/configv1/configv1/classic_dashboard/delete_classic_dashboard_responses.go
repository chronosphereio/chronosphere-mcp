...
func (o *DeleteClassicDashboardOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/classic-dashboards/{slug}][%d] deleteClassicDashboardOK %s", 200, payload)
}
...
func (o *DeleteClassicDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/classic-dashboards/{slug}][%d] deleteClassicDashboardBadRequest %s", 400, payload)
}
...
func (o *DeleteClassicDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/classic-dashboards/{slug}][%d] deleteClassicDashboardNotFound %s", 404, payload)
}
...
func (o *DeleteClassicDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/classic-dashboards/{slug}][%d] deleteClassicDashboardInternalServerError %s", 500, payload)
}
...
func (o *DeleteClassicDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/classic-dashboards/{slug}][%d] DeleteClassicDashboard default %s", o._statusCode, payload)
}
