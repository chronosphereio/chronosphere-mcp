...
func (o *ListClassicDashboardsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards][%d] listClassicDashboardsOK %s", 200, payload)
}
...
func (o *ListClassicDashboardsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards][%d] listClassicDashboardsInternalServerError %s", 500, payload)
}
...
func (o *ListClassicDashboardsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards][%d] ListClassicDashboards default %s", o._statusCode, payload)
}
