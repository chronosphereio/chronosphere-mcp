...
func (o *ReadClassicDashboardOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards/{slug}][%d] readClassicDashboardOK %s", 200, payload)
}
...
func (o *ReadClassicDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards/{slug}][%d] readClassicDashboardNotFound %s", 404, payload)
}
...
func (o *ReadClassicDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards/{slug}][%d] readClassicDashboardInternalServerError %s", 500, payload)
}
...
func (o *ReadClassicDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/classic-dashboards/{slug}][%d] ReadClassicDashboard default %s", o._statusCode, payload)
}
