...
func (o *UpdateClassicDashboardOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] updateClassicDashboardOK %s", 200, payload)
}
...
func (o *UpdateClassicDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] updateClassicDashboardBadRequest %s", 400, payload)
}
...
func (o *UpdateClassicDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] updateClassicDashboardNotFound %s", 404, payload)
}
...
func (o *UpdateClassicDashboardConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] updateClassicDashboardConflict %s", 409, payload)
}
...
func (o *UpdateClassicDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] updateClassicDashboardInternalServerError %s", 500, payload)
}
...
func (o *UpdateClassicDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/classic-dashboards/{slug}][%d] UpdateClassicDashboard default %s", o._statusCode, payload)
}
