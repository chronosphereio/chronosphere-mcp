...
func (o *CreateCollectionOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/collections][%d] createCollectionOK %s", 200, payload)
}
...
func (o *CreateCollectionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/collections][%d] createCollectionBadRequest %s", 400, payload)
}
...
func (o *CreateCollectionConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/collections][%d] createCollectionConflict %s", 409, payload)
}
...
func (o *CreateCollectionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/collections][%d] createCollectionInternalServerError %s", 500, payload)
}
...
func (o *CreateCollectionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/collections][%d] CreateCollection default %s", o._statusCode, payload)
}
