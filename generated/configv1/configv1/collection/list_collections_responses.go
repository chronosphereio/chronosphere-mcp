...
func (o *ListCollectionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/collections][%d] listCollectionsOK %s", 200, payload)
}
...
func (o *ListCollectionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/collections][%d] listCollectionsInternalServerError %s", 500, payload)
}
...
func (o *ListCollectionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/collections][%d] ListCollections default %s", o._statusCode, payload)
}
