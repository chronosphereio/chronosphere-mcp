...
func (o *ReadCollectionOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/collections/{slug}][%d] readCollectionOK %s", 200, payload)
}
...
func (o *ReadCollectionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/collections/{slug}][%d] readCollectionNotFound %s", 404, payload)
}
...
func (o *ReadCollectionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/collections/{slug}][%d] readCollectionInternalServerError %s", 500, payload)
}
...
func (o *ReadCollectionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/collections/{slug}][%d] ReadCollection default %s", o._statusCode, payload)
}
