...
func (o *CreateDashboardOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/dashboards][%d] createDashboardOK %s", 200, payload)
}
...
func (o *CreateDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/dashboards][%d] createDashboardBadRequest %s", 400, payload)
}
...
func (o *CreateDashboardConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/dashboards][%d] createDashboardConflict %s", 409, payload)
}
...
func (o *CreateDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/dashboards][%d] createDashboardInternalServerError %s", 500, payload)
}
...
func (o *CreateDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/dashboards][%d] CreateDashboard default %s", o._statusCode, payload)
}
