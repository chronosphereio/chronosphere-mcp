...
func (o *DeleteDashboardOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/dashboards/{slug}][%d] deleteDashboardOK %s", 200, payload)
}
...
func (o *DeleteDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/dashboards/{slug}][%d] deleteDashboardBadRequest %s", 400, payload)
}
...
func (o *DeleteDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/dashboards/{slug}][%d] deleteDashboardNotFound %s", 404, payload)
}
...
func (o *DeleteDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/dashboards/{slug}][%d] deleteDashboardInternalServerError %s", 500, payload)
}
...
func (o *DeleteDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/dashboards/{slug}][%d] DeleteDashboard default %s", o._statusCode, payload)
}
