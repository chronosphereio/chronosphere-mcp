...
func (o *ReadDashboardOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/dashboards/{slug}][%d] readDashboardOK %s", 200, payload)
}
...
func (o *ReadDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/dashboards/{slug}][%d] readDashboardNotFound %s", 404, payload)
}
...
func (o *ReadDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/dashboards/{slug}][%d] readDashboardInternalServerError %s", 500, payload)
}
...
func (o *ReadDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/dashboards/{slug}][%d] ReadDashboard default %s", o._statusCode, payload)
}
