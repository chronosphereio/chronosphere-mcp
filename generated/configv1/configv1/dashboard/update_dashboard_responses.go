...
func (o *UpdateDashboardOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] updateDashboardOK %s", 200, payload)
}
...
func (o *UpdateDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] updateDashboardBadRequest %s", 400, payload)
}
...
func (o *UpdateDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] updateDashboardNotFound %s", 404, payload)
}
...
func (o *UpdateDashboardConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] updateDashboardConflict %s", 409, payload)
}
...
func (o *UpdateDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] updateDashboardInternalServerError %s", 500, payload)
}
...
func (o *UpdateDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/dashboards/{slug}][%d] UpdateDashboard default %s", o._statusCode, payload)
}
