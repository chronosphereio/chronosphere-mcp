...
func (o *CreateDatasetOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetOK %s", 200, payload)
}
...
func (o *CreateDatasetBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetBadRequest %s", 400, payload)
}
...
func (o *CreateDatasetConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetConflict %s", 409, payload)
}
...
func (o *CreateDatasetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetInternalServerError %s", 500, payload)
}
...
func (o *CreateDatasetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] CreateDataset default %s", o._statusCode, payload)
}
