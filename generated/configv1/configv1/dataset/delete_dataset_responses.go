...
func (o *DeleteDatasetOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/datasets/{slug}][%d] deleteDatasetOK %s", 200, payload)
}
...
func (o *DeleteDatasetBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/datasets/{slug}][%d] deleteDatasetBadRequest %s", 400, payload)
}
...
func (o *DeleteDatasetNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/datasets/{slug}][%d] deleteDatasetNotFound %s", 404, payload)
}
...
func (o *DeleteDatasetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/datasets/{slug}][%d] deleteDatasetInternalServerError %s", 500, payload)
}
...
func (o *DeleteDatasetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/datasets/{slug}][%d] DeleteDataset default %s", o._statusCode, payload)
}
