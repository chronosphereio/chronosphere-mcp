...
func (o *ListDatasetsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/datasets][%d] listDatasetsOK %s", 200, payload)
}
...
func (o *ListDatasetsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/datasets][%d] listDatasetsInternalServerError %s", 500, payload)
}
...
func (o *ListDatasetsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/datasets][%d] ListDatasets default %s", o._statusCode, payload)
}
