...
func (o *ReadDatasetOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/datasets/{slug}][%d] readDatasetOK %s", 200, payload)
}
...
func (o *ReadDatasetNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/datasets/{slug}][%d] readDatasetNotFound %s", 404, payload)
}
...
func (o *ReadDatasetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/datasets/{slug}][%d] readDatasetInternalServerError %s", 500, payload)
}
...
func (o *ReadDatasetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/datasets/{slug}][%d] ReadDataset default %s", o._statusCode, payload)
}
