...
func (o *UpdateDatasetOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] updateDatasetOK %s", 200, payload)
}
...
func (o *UpdateDatasetBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] updateDatasetBadRequest %s", 400, payload)
}
...
func (o *UpdateDatasetNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] updateDatasetNotFound %s", 404, payload)
}
...
func (o *UpdateDatasetConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] updateDatasetConflict %s", 409, payload)
}
...
func (o *UpdateDatasetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] updateDatasetInternalServerError %s", 500, payload)
}
...
func (o *UpdateDatasetDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/datasets/{slug}][%d] UpdateDataset default %s", o._statusCode, payload)
}
