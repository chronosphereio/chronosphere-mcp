...
func (o *CreateDerivedLabelOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/derived-labels][%d] createDerivedLabelOK %s", 200, payload)
}
...
func (o *CreateDerivedLabelBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-labels][%d] createDerivedLabelBadRequest %s", 400, payload)
}
...
func (o *CreateDerivedLabelConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-labels][%d] createDerivedLabelConflict %s", 409, payload)
}
...
func (o *CreateDerivedLabelInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-labels][%d] createDerivedLabelInternalServerError %s", 500, payload)
}
...
func (o *CreateDerivedLabelDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-labels][%d] CreateDerivedLabel default %s", o._statusCode, payload)
}
