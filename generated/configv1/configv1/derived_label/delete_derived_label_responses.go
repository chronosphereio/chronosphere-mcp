...
func (o *DeleteDerivedLabelOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/derived-labels/{slug}][%d] deleteDerivedLabelOK %s", 200, payload)
}
...
func (o *DeleteDerivedLabelBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-labels/{slug}][%d] deleteDerivedLabelBadRequest %s", 400, payload)
}
...
func (o *DeleteDerivedLabelNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-labels/{slug}][%d] deleteDerivedLabelNotFound %s", 404, payload)
}
...
func (o *DeleteDerivedLabelInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-labels/{slug}][%d] deleteDerivedLabelInternalServerError %s", 500, payload)
}
...
func (o *DeleteDerivedLabelDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-labels/{slug}][%d] DeleteDerivedLabel default %s", o._statusCode, payload)
}
