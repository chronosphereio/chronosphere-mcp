...
func (o *ListDerivedLabelsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/derived-labels][%d] listDerivedLabelsOK %s", 200, payload)
}
...
func (o *ListDerivedLabelsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-labels][%d] listDerivedLabelsInternalServerError %s", 500, payload)
}
...
func (o *ListDerivedLabelsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-labels][%d] ListDerivedLabels default %s", o._statusCode, payload)
}
