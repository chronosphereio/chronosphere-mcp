...
func (o *ReadDerivedLabelOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/derived-labels/{slug}][%d] readDerivedLabelOK %s", 200, payload)
}
...
func (o *ReadDerivedLabelNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-labels/{slug}][%d] readDerivedLabelNotFound %s", 404, payload)
}
...
func (o *ReadDerivedLabelInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-labels/{slug}][%d] readDerivedLabelInternalServerError %s", 500, payload)
}
...
func (o *ReadDerivedLabelDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-labels/{slug}][%d] ReadDerivedLabel default %s", o._statusCode, payload)
}
