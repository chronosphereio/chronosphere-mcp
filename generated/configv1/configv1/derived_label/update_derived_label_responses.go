...
func (o *UpdateDerivedLabelOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] updateDerivedLabelOK %s", 200, payload)
}
...
func (o *UpdateDerivedLabelBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] updateDerivedLabelBadRequest %s", 400, payload)
}
...
func (o *UpdateDerivedLabelNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] updateDerivedLabelNotFound %s", 404, payload)
}
...
func (o *UpdateDerivedLabelConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] updateDerivedLabelConflict %s", 409, payload)
}
...
func (o *UpdateDerivedLabelInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] updateDerivedLabelInternalServerError %s", 500, payload)
}
...
func (o *UpdateDerivedLabelDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-labels/{slug}][%d] UpdateDerivedLabel default %s", o._statusCode, payload)
}
