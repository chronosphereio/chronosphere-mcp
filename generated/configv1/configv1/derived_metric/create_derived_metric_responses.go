...
func (o *CreateDerivedMetricOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/derived-metrics][%d] createDerivedMetricOK %s", 200, payload)
}
...
func (o *CreateDerivedMetricBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-metrics][%d] createDerivedMetricBadRequest %s", 400, payload)
}
...
func (o *CreateDerivedMetricConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-metrics][%d] createDerivedMetricConflict %s", 409, payload)
}
...
func (o *CreateDerivedMetricInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-metrics][%d] createDerivedMetricInternalServerError %s", 500, payload)
}
...
func (o *CreateDerivedMetricDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/derived-metrics][%d] CreateDerivedMetric default %s", o._statusCode, payload)
}
