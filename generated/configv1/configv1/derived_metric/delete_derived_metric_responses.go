...
func (o *DeleteDerivedMetricOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/derived-metrics/{slug}][%d] deleteDerivedMetricOK %s", 200, payload)
}
...
func (o *DeleteDerivedMetricBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-metrics/{slug}][%d] deleteDerivedMetricBadRequest %s", 400, payload)
}
...
func (o *DeleteDerivedMetricNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-metrics/{slug}][%d] deleteDerivedMetricNotFound %s", 404, payload)
}
...
func (o *DeleteDerivedMetricInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-metrics/{slug}][%d] deleteDerivedMetricInternalServerError %s", 500, payload)
}
...
func (o *DeleteDerivedMetricDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/derived-metrics/{slug}][%d] DeleteDerivedMetric default %s", o._statusCode, payload)
}
