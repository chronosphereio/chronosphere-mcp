...
func (o *ListDerivedMetricsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] listDerivedMetricsOK %s", 200, payload)
}
...
func (o *ListDerivedMetricsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] listDerivedMetricsInternalServerError %s", 500, payload)
}
...
func (o *ListDerivedMetricsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] ListDerivedMetrics default %s", o._statusCode, payload)
}
