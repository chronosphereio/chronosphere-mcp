...
func (o *ReadDerivedMetricOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics/{slug}][%d] readDerivedMetricOK %s", 200, payload)
}
...
func (o *ReadDerivedMetricNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics/{slug}][%d] readDerivedMetricNotFound %s", 404, payload)
}
...
func (o *ReadDerivedMetricInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics/{slug}][%d] readDerivedMetricInternalServerError %s", 500, payload)
}
...
func (o *ReadDerivedMetricDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics/{slug}][%d] ReadDerivedMetric default %s", o._statusCode, payload)
}
