...
func (o *UpdateDerivedMetricOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] updateDerivedMetricOK %s", 200, payload)
}
...
func (o *UpdateDerivedMetricBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] updateDerivedMetricBadRequest %s", 400, payload)
}
...
func (o *UpdateDerivedMetricNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] updateDerivedMetricNotFound %s", 404, payload)
}
...
func (o *UpdateDerivedMetricConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] updateDerivedMetricConflict %s", 409, payload)
}
...
func (o *UpdateDerivedMetricInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] updateDerivedMetricInternalServerError %s", 500, payload)
}
...
func (o *UpdateDerivedMetricDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/derived-metrics/{slug}][%d] UpdateDerivedMetric default %s", o._statusCode, payload)
}
