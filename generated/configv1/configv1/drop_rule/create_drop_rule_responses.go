...
func (o *CreateDropRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/drop-rules][%d] createDropRuleOK %s", 200, payload)
}
...
func (o *CreateDropRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/drop-rules][%d] createDropRuleBadRequest %s", 400, payload)
}
...
func (o *CreateDropRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/drop-rules][%d] createDropRuleConflict %s", 409, payload)
}
...
func (o *CreateDropRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/drop-rules][%d] createDropRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateDropRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/drop-rules][%d] CreateDropRule default %s", o._statusCode, payload)
}
