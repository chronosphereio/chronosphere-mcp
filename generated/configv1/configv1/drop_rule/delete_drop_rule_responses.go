...
func (o *DeleteDropRuleOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/drop-rules/{slug}][%d] deleteDropRuleOK %s", 200, payload)
}
...
func (o *DeleteDropRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/drop-rules/{slug}][%d] deleteDropRuleBadRequest %s", 400, payload)
}
...
func (o *DeleteDropRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/drop-rules/{slug}][%d] deleteDropRuleNotFound %s", 404, payload)
}
...
func (o *DeleteDropRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/drop-rules/{slug}][%d] deleteDropRuleInternalServerError %s", 500, payload)
}
...
func (o *DeleteDropRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/drop-rules/{slug}][%d] DeleteDropRule default %s", o._statusCode, payload)
}
