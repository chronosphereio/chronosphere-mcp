...
func (o *ListDropRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/drop-rules][%d] listDropRulesOK %s", 200, payload)
}
...
func (o *ListDropRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/drop-rules][%d] listDropRulesInternalServerError %s", 500, payload)
}
...
func (o *ListDropRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/drop-rules][%d] ListDropRules default %s", o._statusCode, payload)
}
