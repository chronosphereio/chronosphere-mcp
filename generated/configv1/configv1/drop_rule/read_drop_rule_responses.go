...
func (o *ReadDropRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/drop-rules/{slug}][%d] readDropRuleOK %s", 200, payload)
}
...
func (o *ReadDropRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/drop-rules/{slug}][%d] readDropRuleNotFound %s", 404, payload)
}
...
func (o *ReadDropRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/drop-rules/{slug}][%d] readDropRuleInternalServerError %s", 500, payload)
}
...
func (o *ReadDropRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/drop-rules/{slug}][%d] ReadDropRule default %s", o._statusCode, payload)
}
