...
func (o *UpdateDropRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] updateDropRuleOK %s", 200, payload)
}
...
func (o *UpdateDropRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] updateDropRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateDropRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] updateDropRuleNotFound %s", 404, payload)
}
...
func (o *UpdateDropRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] updateDropRuleConflict %s", 409, payload)
}
...
func (o *UpdateDropRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] updateDropRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateDropRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/drop-rules/{slug}][%d] UpdateDropRule default %s", o._statusCode, payload)
}
