...
func (o *CreateGcpMetricsIntegrationOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/gcp-metrics-integrations][%d] createGcpMetricsIntegrationOK %s", 200, payload)
}
...
func (o *CreateGcpMetricsIntegrationBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/gcp-metrics-integrations][%d] createGcpMetricsIntegrationBadRequest %s", 400, payload)
}
...
func (o *CreateGcpMetricsIntegrationConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/gcp-metrics-integrations][%d] createGcpMetricsIntegrationConflict %s", 409, payload)
}
...
func (o *CreateGcpMetricsIntegrationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/gcp-metrics-integrations][%d] createGcpMetricsIntegrationInternalServerError %s", 500, payload)
}
...
func (o *CreateGcpMetricsIntegrationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/gcp-metrics-integrations][%d] CreateGcpMetricsIntegration default %s", o._statusCode, payload)
}
