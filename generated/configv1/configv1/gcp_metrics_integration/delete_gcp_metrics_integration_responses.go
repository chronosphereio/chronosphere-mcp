...
func (o *DeleteGcpMetricsIntegrationOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/gcp-metrics-integrations/{slug}][%d] deleteGcpMetricsIntegrationOK %s", 200, payload)
}
...
func (o *DeleteGcpMetricsIntegrationBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/gcp-metrics-integrations/{slug}][%d] deleteGcpMetricsIntegrationBadRequest %s", 400, payload)
}
...
func (o *DeleteGcpMetricsIntegrationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/gcp-metrics-integrations/{slug}][%d] deleteGcpMetricsIntegrationNotFound %s", 404, payload)
}
...
func (o *DeleteGcpMetricsIntegrationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/gcp-metrics-integrations/{slug}][%d] deleteGcpMetricsIntegrationInternalServerError %s", 500, payload)
}
...
func (o *DeleteGcpMetricsIntegrationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/gcp-metrics-integrations/{slug}][%d] DeleteGcpMetricsIntegration default %s", o._statusCode, payload)
}
