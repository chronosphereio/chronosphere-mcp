...
func (o *ListGcpMetricsIntegrationsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations][%d] listGcpMetricsIntegrationsOK %s", 200, payload)
}
...
func (o *ListGcpMetricsIntegrationsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations][%d] listGcpMetricsIntegrationsInternalServerError %s", 500, payload)
}
...
func (o *ListGcpMetricsIntegrationsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations][%d] ListGcpMetricsIntegrations default %s", o._statusCode, payload)
}
