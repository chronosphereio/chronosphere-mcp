...
func (o *ReadGcpMetricsIntegrationOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations/{slug}][%d] readGcpMetricsIntegrationOK %s", 200, payload)
}
...
func (o *ReadGcpMetricsIntegrationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations/{slug}][%d] readGcpMetricsIntegrationNotFound %s", 404, payload)
}
...
func (o *ReadGcpMetricsIntegrationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations/{slug}][%d] readGcpMetricsIntegrationInternalServerError %s", 500, payload)
}
...
func (o *ReadGcpMetricsIntegrationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/gcp-metrics-integrations/{slug}][%d] ReadGcpMetricsIntegration default %s", o._statusCode, payload)
}
