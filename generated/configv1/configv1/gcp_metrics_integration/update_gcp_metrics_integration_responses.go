...
func (o *UpdateGcpMetricsIntegrationOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] updateGcpMetricsIntegrationOK %s", 200, payload)
}
...
func (o *UpdateGcpMetricsIntegrationBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] updateGcpMetricsIntegrationBadRequest %s", 400, payload)
}
...
func (o *UpdateGcpMetricsIntegrationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] updateGcpMetricsIntegrationNotFound %s", 404, payload)
}
...
func (o *UpdateGcpMetricsIntegrationConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] updateGcpMetricsIntegrationConflict %s", 409, payload)
}
...
func (o *UpdateGcpMetricsIntegrationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] updateGcpMetricsIntegrationInternalServerError %s", 500, payload)
}
...
func (o *UpdateGcpMetricsIntegrationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/gcp-metrics-integrations/{slug}][%d] UpdateGcpMetricsIntegration default %s", o._statusCode, payload)
}
