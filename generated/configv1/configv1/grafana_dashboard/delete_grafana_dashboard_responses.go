...
func (o *DeleteGrafanaDashboardOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/grafana-dashboards/{slug}][%d] deleteGrafanaDashboardOK %s", 200, payload)
}
...
func (o *DeleteGrafanaDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/grafana-dashboards/{slug}][%d] deleteGrafanaDashboardBadRequest %s", 400, payload)
}
...
func (o *DeleteGrafanaDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/grafana-dashboards/{slug}][%d] deleteGrafanaDashboardNotFound %s", 404, payload)
}
...
func (o *DeleteGrafanaDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/grafana-dashboards/{slug}][%d] deleteGrafanaDashboardInternalServerError %s", 500, payload)
}
...
func (o *DeleteGrafanaDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/grafana-dashboards/{slug}][%d] DeleteGrafanaDashboard default %s", o._statusCode, payload)
}
