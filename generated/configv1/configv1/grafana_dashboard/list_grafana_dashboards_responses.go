...
func (o *ListGrafanaDashboardsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards][%d] listGrafanaDashboardsOK %s", 200, payload)
}
...
func (o *ListGrafanaDashboardsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards][%d] listGrafanaDashboardsInternalServerError %s", 500, payload)
}
...
func (o *ListGrafanaDashboardsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards][%d] ListGrafanaDashboards default %s", o._statusCode, payload)
}
