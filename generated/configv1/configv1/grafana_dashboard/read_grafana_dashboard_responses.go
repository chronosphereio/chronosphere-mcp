...
func (o *ReadGrafanaDashboardOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards/{slug}][%d] readGrafanaDashboardOK %s", 200, payload)
}
...
func (o *ReadGrafanaDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards/{slug}][%d] readGrafanaDashboardNotFound %s", 404, payload)
}
...
func (o *ReadGrafanaDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards/{slug}][%d] readGrafanaDashboardInternalServerError %s", 500, payload)
}
...
func (o *ReadGrafanaDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/grafana-dashboards/{slug}][%d] ReadGrafanaDashboard default %s", o._statusCode, payload)
}
