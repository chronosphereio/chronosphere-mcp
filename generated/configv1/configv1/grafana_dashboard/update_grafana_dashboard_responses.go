...
func (o *UpdateGrafanaDashboardOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] updateGrafanaDashboardOK %s", 200, payload)
}
...
func (o *UpdateGrafanaDashboardBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] updateGrafanaDashboardBadRequest %s", 400, payload)
}
...
func (o *UpdateGrafanaDashboardNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] updateGrafanaDashboardNotFound %s", 404, payload)
}
...
func (o *UpdateGrafanaDashboardConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] updateGrafanaDashboardConflict %s", 409, payload)
}
...
func (o *UpdateGrafanaDashboardInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] updateGrafanaDashboardInternalServerError %s", 500, payload)
}
...
func (o *UpdateGrafanaDashboardDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/grafana-dashboards/{slug}][%d] UpdateGrafanaDashboard default %s", o._statusCode, payload)
}
