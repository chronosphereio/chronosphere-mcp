...
func (o *CreateLogAllocationConfigOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/log-allocation-config][%d] createLogAllocationConfigOK %s", 200, payload)
}
...
func (o *CreateLogAllocationConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-allocation-config][%d] createLogAllocationConfigBadRequest %s", 400, payload)
}
...
func (o *CreateLogAllocationConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-allocation-config][%d] createLogAllocationConfigConflict %s", 409, payload)
}
...
func (o *CreateLogAllocationConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-allocation-config][%d] createLogAllocationConfigInternalServerError %s", 500, payload)
}
...
func (o *CreateLogAllocationConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-allocation-config][%d] CreateLogAllocationConfig default %s", o._statusCode, payload)
}
