...
func (o *DeleteLogAllocationConfigOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/log-allocation-config][%d] deleteLogAllocationConfigOK %s", 200, payload)
}
...
func (o *DeleteLogAllocationConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-allocation-config][%d] deleteLogAllocationConfigBadRequest %s", 400, payload)
}
...
func (o *DeleteLogAllocationConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-allocation-config][%d] deleteLogAllocationConfigNotFound %s", 404, payload)
}
...
func (o *DeleteLogAllocationConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-allocation-config][%d] deleteLogAllocationConfigInternalServerError %s", 500, payload)
}
...
func (o *DeleteLogAllocationConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-allocation-config][%d] DeleteLogAllocationConfig default %s", o._statusCode, payload)
}
