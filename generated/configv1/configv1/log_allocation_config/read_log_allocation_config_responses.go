...
func (o *ReadLogAllocationConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-allocation-config][%d] readLogAllocationConfigOK %s", 200, payload)
}
...
func (o *ReadLogAllocationConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-allocation-config][%d] readLogAllocationConfigNotFound %s", 404, payload)
}
...
func (o *ReadLogAllocationConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-allocation-config][%d] readLogAllocationConfigInternalServerError %s", 500, payload)
}
...
func (o *ReadLogAllocationConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-allocation-config][%d] ReadLogAllocationConfig default %s", o._statusCode, payload)
}
