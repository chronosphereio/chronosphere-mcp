...
func (o *UpdateLogAllocationConfigOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/log-allocation-config][%d] updateLogAllocationConfigOK %s", 200, payload)
}
...
func (o *UpdateLogAllocationConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-allocation-config][%d] updateLogAllocationConfigBadRequest %s", 400, payload)
}
...
func (o *UpdateLogAllocationConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-allocation-config][%d] updateLogAllocationConfigNotFound %s", 404, payload)
}
...
func (o *UpdateLogAllocationConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-allocation-config][%d] updateLogAllocationConfigInternalServerError %s", 500, payload)
}
...
func (o *UpdateLogAllocationConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-allocation-config][%d] UpdateLogAllocationConfig default %s", o._statusCode, payload)
}
