...
func (o *CreateLogIngestConfigOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/log-ingest-config][%d] createLogIngestConfigOK %s", 200, payload)
}
...
func (o *CreateLogIngestConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-ingest-config][%d] createLogIngestConfigBadRequest %s", 400, payload)
}
...
func (o *CreateLogIngestConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-ingest-config][%d] createLogIngestConfigConflict %s", 409, payload)
}
...
func (o *CreateLogIngestConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-ingest-config][%d] createLogIngestConfigInternalServerError %s", 500, payload)
}
...
func (o *CreateLogIngestConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-ingest-config][%d] CreateLogIngestConfig default %s", o._statusCode, payload)
}
