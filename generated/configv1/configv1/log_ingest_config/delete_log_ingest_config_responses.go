...
func (o *DeleteLogIngestConfigOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/log-ingest-config][%d] deleteLogIngestConfigOK %s", 200, payload)
}
...
func (o *DeleteLogIngestConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-ingest-config][%d] deleteLogIngestConfigBadRequest %s", 400, payload)
}
...
func (o *DeleteLogIngestConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-ingest-config][%d] deleteLogIngestConfigNotFound %s", 404, payload)
}
...
func (o *DeleteLogIngestConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-ingest-config][%d] deleteLogIngestConfigInternalServerError %s", 500, payload)
}
...
func (o *DeleteLogIngestConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-ingest-config][%d] DeleteLogIngestConfig default %s", o._statusCode, payload)
}
