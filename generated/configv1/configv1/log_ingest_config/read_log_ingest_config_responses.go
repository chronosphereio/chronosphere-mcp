...
func (o *ReadLogIngestConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-ingest-config][%d] readLogIngestConfigOK %s", 200, payload)
}
...
func (o *ReadLogIngestConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-ingest-config][%d] readLogIngestConfigNotFound %s", 404, payload)
}
...
func (o *ReadLogIngestConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-ingest-config][%d] readLogIngestConfigInternalServerError %s", 500, payload)
}
...
func (o *ReadLogIngestConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-ingest-config][%d] ReadLogIngestConfig default %s", o._statusCode, payload)
}
