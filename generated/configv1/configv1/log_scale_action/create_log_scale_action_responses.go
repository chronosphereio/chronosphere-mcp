...
func (o *CreateLogScaleActionOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionOK %s", 200, payload)
}
...
func (o *CreateLogScaleActionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionBadRequest %s", 400, payload)
}
...
func (o *CreateLogScaleActionConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionConflict %s", 409, payload)
}
...
func (o *CreateLogScaleActionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionInternalServerError %s", 500, payload)
}
...
func (o *CreateLogScaleActionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] CreateLogScaleAction default %s", o._statusCode, payload)
}
