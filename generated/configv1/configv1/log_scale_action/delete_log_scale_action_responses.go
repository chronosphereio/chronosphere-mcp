...
func (o *DeleteLogScaleActionOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-actions/{slug}][%d] deleteLogScaleActionOK %s", 200, payload)
}
...
func (o *DeleteLogScaleActionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-actions/{slug}][%d] deleteLogScaleActionBadRequest %s", 400, payload)
}
...
func (o *DeleteLogScaleActionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-actions/{slug}][%d] deleteLogScaleActionNotFound %s", 404, payload)
}
...
func (o *DeleteLogScaleActionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-actions/{slug}][%d] deleteLogScaleActionInternalServerError %s", 500, payload)
}
...
func (o *DeleteLogScaleActionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-actions/{slug}][%d] DeleteLogScaleAction default %s", o._statusCode, payload)
}
