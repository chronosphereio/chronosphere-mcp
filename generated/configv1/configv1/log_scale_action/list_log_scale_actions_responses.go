...
func (o *ListLogScaleActionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] listLogScaleActionsOK %s", 200, payload)
}
...
func (o *ListLogScaleActionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] listLogScaleActionsInternalServerError %s", 500, payload)
}
...
func (o *ListLogScaleActionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] ListLogScaleActions default %s", o._statusCode, payload)
}
