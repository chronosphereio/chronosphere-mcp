...
func (o *ReadLogScaleActionOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionOK %s", 200, payload)
}
...
func (o *ReadLogScaleActionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionNotFound %s", 404, payload)
}
...
func (o *ReadLogScaleActionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionInternalServerError %s", 500, payload)
}
...
func (o *ReadLogScaleActionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] ReadLogScaleAction default %s", o._statusCode, payload)
}
