...
func (o *UpdateLogScaleActionOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionOK %s", 200, payload)
}
...
func (o *UpdateLogScaleActionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionBadRequest %s", 400, payload)
}
...
func (o *UpdateLogScaleActionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionNotFound %s", 404, payload)
}
...
func (o *UpdateLogScaleActionConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionConflict %s", 409, payload)
}
...
func (o *UpdateLogScaleActionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionInternalServerError %s", 500, payload)
}
...
func (o *UpdateLogScaleActionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] UpdateLogScaleAction default %s", o._statusCode, payload)
}
