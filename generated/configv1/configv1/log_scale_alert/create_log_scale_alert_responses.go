...
func (o *CreateLogScaleAlertOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/log-scale-alerts][%d] createLogScaleAlertOK %s", 200, payload)
}
...
func (o *CreateLogScaleAlertBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-alerts][%d] createLogScaleAlertBadRequest %s", 400, payload)
}
...
func (o *CreateLogScaleAlertConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-alerts][%d] createLogScaleAlertConflict %s", 409, payload)
}
...
func (o *CreateLogScaleAlertInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-alerts][%d] createLogScaleAlertInternalServerError %s", 500, payload)
}
...
func (o *CreateLogScaleAlertDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/log-scale-alerts][%d] CreateLogScaleAlert default %s", o._statusCode, payload)
}
