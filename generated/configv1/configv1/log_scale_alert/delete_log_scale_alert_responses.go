...
func (o *DeleteLogScaleAlertOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertOK %s", 200, payload)
}
...
func (o *DeleteLogScaleAlertBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertBadRequest %s", 400, payload)
}
...
func (o *DeleteLogScaleAlertNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertNotFound %s", 404, payload)
}
...
func (o *DeleteLogScaleAlertInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertInternalServerError %s", 500, payload)
}
...
func (o *DeleteLogScaleAlertDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/log-scale-alerts/{slug}][%d] DeleteLogScaleAlert default %s", o._statusCode, payload)
}
