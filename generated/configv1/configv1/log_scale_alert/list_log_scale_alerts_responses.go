...
func (o *ListLogScaleAlertsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts][%d] listLogScaleAlertsOK %s", 200, payload)
}
...
func (o *ListLogScaleAlertsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts][%d] listLogScaleAlertsInternalServerError %s", 500, payload)
}
...
func (o *ListLogScaleAlertsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts][%d] ListLogScaleAlerts default %s", o._statusCode, payload)
}
