...
func (o *ReadLogScaleAlertOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts/{slug}][%d] readLogScaleAlertOK %s", 200, payload)
}
...
func (o *ReadLogScaleAlertNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts/{slug}][%d] readLogScaleAlertNotFound %s", 404, payload)
}
...
func (o *ReadLogScaleAlertInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts/{slug}][%d] readLogScaleAlertInternalServerError %s", 500, payload)
}
...
func (o *ReadLogScaleAlertDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/log-scale-alerts/{slug}][%d] ReadLogScaleAlert default %s", o._statusCode, payload)
}
