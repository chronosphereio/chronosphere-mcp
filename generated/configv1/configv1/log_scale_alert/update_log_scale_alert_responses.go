...
func (o *UpdateLogScaleAlertOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertOK %s", 200, payload)
}
...
func (o *UpdateLogScaleAlertBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertBadRequest %s", 400, payload)
}
...
func (o *UpdateLogScaleAlertNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertNotFound %s", 404, payload)
}
...
func (o *UpdateLogScaleAlertConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertConflict %s", 409, payload)
}
...
func (o *UpdateLogScaleAlertInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertInternalServerError %s", 500, payload)
}
...
func (o *UpdateLogScaleAlertDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-alerts/{slug}][%d] UpdateLogScaleAlert default %s", o._statusCode, payload)
}
