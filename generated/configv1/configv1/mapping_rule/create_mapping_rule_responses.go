...
func (o *CreateMappingRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/mapping-rules][%d] createMappingRuleOK %s", 200, payload)
}
...
func (o *CreateMappingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/mapping-rules][%d] createMappingRuleBadRequest %s", 400, payload)
}
...
func (o *CreateMappingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/mapping-rules][%d] createMappingRuleConflict %s", 409, payload)
}
...
func (o *CreateMappingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/mapping-rules][%d] createMappingRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateMappingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/mapping-rules][%d] CreateMappingRule default %s", o._statusCode, payload)
}
