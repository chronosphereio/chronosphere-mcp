...
func (o *DeleteMappingRuleOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/mapping-rules/{slug}][%d] deleteMappingRuleOK %s", 200, payload)
}
...
func (o *DeleteMappingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/mapping-rules/{slug}][%d] deleteMappingRuleBadRequest %s", 400, payload)
}
...
func (o *DeleteMappingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/mapping-rules/{slug}][%d] deleteMappingRuleNotFound %s", 404, payload)
}
...
func (o *DeleteMappingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/mapping-rules/{slug}][%d] deleteMappingRuleInternalServerError %s", 500, payload)
}
...
func (o *DeleteMappingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/mapping-rules/{slug}][%d] DeleteMappingRule default %s", o._statusCode, payload)
}
