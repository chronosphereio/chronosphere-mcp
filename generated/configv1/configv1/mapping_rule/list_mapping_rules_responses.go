...
func (o *ListMappingRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules][%d] listMappingRulesOK %s", 200, payload)
}
...
func (o *ListMappingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules][%d] listMappingRulesInternalServerError %s", 500, payload)
}
...
func (o *ListMappingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules][%d] ListMappingRules default %s", o._statusCode, payload)
}
