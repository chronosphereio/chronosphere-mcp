...
func (o *ReadMappingRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules/{slug}][%d] readMappingRuleOK %s", 200, payload)
}
...
func (o *ReadMappingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules/{slug}][%d] readMappingRuleNotFound %s", 404, payload)
}
...
func (o *ReadMappingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules/{slug}][%d] readMappingRuleInternalServerError %s", 500, payload)
}
...
func (o *ReadMappingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/mapping-rules/{slug}][%d] ReadMappingRule default %s", o._statusCode, payload)
}
