...
func (o *UpdateMappingRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] updateMappingRuleOK %s", 200, payload)
}
...
func (o *UpdateMappingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] updateMappingRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateMappingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] updateMappingRuleNotFound %s", 404, payload)
}
...
func (o *UpdateMappingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] updateMappingRuleConflict %s", 409, payload)
}
...
func (o *UpdateMappingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] updateMappingRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateMappingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/mapping-rules/{slug}][%d] UpdateMappingRule default %s", o._statusCode, payload)
}
