...
func (o *CreateMonitorOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/monitors][%d] createMonitorOK %s", 200, payload)
}
...
func (o *CreateMonitorBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/monitors][%d] createMonitorBadRequest %s", 400, payload)
}
...
func (o *CreateMonitorConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/monitors][%d] createMonitorConflict %s", 409, payload)
}
...
func (o *CreateMonitorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/monitors][%d] createMonitorInternalServerError %s", 500, payload)
}
...
func (o *CreateMonitorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/monitors][%d] CreateMonitor default %s", o._statusCode, payload)
}
