...
func (o *DeleteMonitorOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/monitors/{slug}][%d] deleteMonitorOK %s", 200, payload)
}
...
func (o *DeleteMonitorBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/monitors/{slug}][%d] deleteMonitorBadRequest %s", 400, payload)
}
...
func (o *DeleteMonitorNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/monitors/{slug}][%d] deleteMonitorNotFound %s", 404, payload)
}
...
func (o *DeleteMonitorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/monitors/{slug}][%d] deleteMonitorInternalServerError %s", 500, payload)
}
...
func (o *DeleteMonitorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/monitors/{slug}][%d] DeleteMonitor default %s", o._statusCode, payload)
}
