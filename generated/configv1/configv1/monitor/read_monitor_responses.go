...
func (o *ReadMonitorOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/monitors/{slug}][%d] readMonitorOK %s", 200, payload)
}
...
func (o *ReadMonitorNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/monitors/{slug}][%d] readMonitorNotFound %s", 404, payload)
}
...
func (o *ReadMonitorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/monitors/{slug}][%d] readMonitorInternalServerError %s", 500, payload)
}
...
func (o *ReadMonitorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/monitors/{slug}][%d] ReadMonitor default %s", o._statusCode, payload)
}
