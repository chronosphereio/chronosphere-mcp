...
func (o *UpdateMonitorOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] updateMonitorOK %s", 200, payload)
}
...
func (o *UpdateMonitorBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] updateMonitorBadRequest %s", 400, payload)
}
...
func (o *UpdateMonitorNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] updateMonitorNotFound %s", 404, payload)
}
...
func (o *UpdateMonitorConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] updateMonitorConflict %s", 409, payload)
}
...
func (o *UpdateMonitorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] updateMonitorInternalServerError %s", 500, payload)
}
...
func (o *UpdateMonitorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/monitors/{slug}][%d] UpdateMonitor default %s", o._statusCode, payload)
}
