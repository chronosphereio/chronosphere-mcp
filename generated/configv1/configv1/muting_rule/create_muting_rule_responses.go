...
func (o *CreateMutingRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/muting-rules][%d] createMutingRuleOK %s", 200, payload)
}
...
func (o *CreateMutingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/muting-rules][%d] createMutingRuleBadRequest %s", 400, payload)
}
...
func (o *CreateMutingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/muting-rules][%d] createMutingRuleConflict %s", 409, payload)
}
...
func (o *CreateMutingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/muting-rules][%d] createMutingRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateMutingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/muting-rules][%d] CreateMutingRule default %s", o._statusCode, payload)
}
