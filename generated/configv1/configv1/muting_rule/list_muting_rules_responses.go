...
func (o *ListMutingRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] listMutingRulesOK %s", 200, payload)
}
...
func (o *ListMutingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] listMutingRulesInternalServerError %s", 500, payload)
}
...
func (o *ListMutingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] ListMutingRules default %s", o._statusCode, payload)
}
