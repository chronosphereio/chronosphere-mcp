...
func (o *ReadMutingRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/muting-rules/{slug}][%d] readMutingRuleOK %s", 200, payload)
}
...
func (o *ReadMutingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/muting-rules/{slug}][%d] readMutingRuleNotFound %s", 404, payload)
}
...
func (o *ReadMutingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/muting-rules/{slug}][%d] readMutingRuleInternalServerError %s", 500, payload)
}
...
func (o *ReadMutingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/muting-rules/{slug}][%d] ReadMutingRule default %s", o._statusCode, payload)
}
