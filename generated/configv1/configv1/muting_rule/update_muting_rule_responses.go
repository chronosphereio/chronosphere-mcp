...
func (o *UpdateMutingRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] updateMutingRuleOK %s", 200, payload)
}
...
func (o *UpdateMutingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] updateMutingRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateMutingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] updateMutingRuleNotFound %s", 404, payload)
}
...
func (o *UpdateMutingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] updateMutingRuleConflict %s", 409, payload)
}
...
func (o *UpdateMutingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] updateMutingRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateMutingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/muting-rules/{slug}][%d] UpdateMutingRule default %s", o._statusCode, payload)
}
