...
func (o *CreateNotificationPolicyOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/notification-policies][%d] createNotificationPolicyOK %s", 200, payload)
}
...
func (o *CreateNotificationPolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notification-policies][%d] createNotificationPolicyBadRequest %s", 400, payload)
}
...
func (o *CreateNotificationPolicyConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notification-policies][%d] createNotificationPolicyConflict %s", 409, payload)
}
...
func (o *CreateNotificationPolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notification-policies][%d] createNotificationPolicyInternalServerError %s", 500, payload)
}
...
func (o *CreateNotificationPolicyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notification-policies][%d] CreateNotificationPolicy default %s", o._statusCode, payload)
}
