...
func (o *DeleteNotificationPolicyOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/notification-policies/{slug}][%d] deleteNotificationPolicyOK %s", 200, payload)
}
...
func (o *DeleteNotificationPolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notification-policies/{slug}][%d] deleteNotificationPolicyBadRequest %s", 400, payload)
}
...
func (o *DeleteNotificationPolicyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notification-policies/{slug}][%d] deleteNotificationPolicyNotFound %s", 404, payload)
}
...
func (o *DeleteNotificationPolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notification-policies/{slug}][%d] deleteNotificationPolicyInternalServerError %s", 500, payload)
}
...
func (o *DeleteNotificationPolicyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notification-policies/{slug}][%d] DeleteNotificationPolicy default %s", o._statusCode, payload)
}
