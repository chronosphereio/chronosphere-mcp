...
func (o *ListNotificationPoliciesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/notification-policies][%d] listNotificationPoliciesOK %s", 200, payload)
}
...
func (o *ListNotificationPoliciesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notification-policies][%d] listNotificationPoliciesInternalServerError %s", 500, payload)
}
...
func (o *ListNotificationPoliciesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notification-policies][%d] ListNotificationPolicies default %s", o._statusCode, payload)
}
