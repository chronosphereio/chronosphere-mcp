...
func (o *UpdateNotificationPolicyOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] updateNotificationPolicyOK %s", 200, payload)
}
...
func (o *UpdateNotificationPolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] updateNotificationPolicyBadRequest %s", 400, payload)
}
...
func (o *UpdateNotificationPolicyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] updateNotificationPolicyNotFound %s", 404, payload)
}
...
func (o *UpdateNotificationPolicyConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] updateNotificationPolicyConflict %s", 409, payload)
}
...
func (o *UpdateNotificationPolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] updateNotificationPolicyInternalServerError %s", 500, payload)
}
...
func (o *UpdateNotificationPolicyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notification-policies/{slug}][%d] UpdateNotificationPolicy default %s", o._statusCode, payload)
}
