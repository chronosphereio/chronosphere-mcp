...
func (o *CreateNotifierOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/notifiers][%d] createNotifierOK %s", 200, payload)
}
...
func (o *CreateNotifierBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notifiers][%d] createNotifierBadRequest %s", 400, payload)
}
...
func (o *CreateNotifierConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notifiers][%d] createNotifierConflict %s", 409, payload)
}
...
func (o *CreateNotifierInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notifiers][%d] createNotifierInternalServerError %s", 500, payload)
}
...
func (o *CreateNotifierDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/notifiers][%d] CreateNotifier default %s", o._statusCode, payload)
}
