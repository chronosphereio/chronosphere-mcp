...
func (o *DeleteNotifierOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/notifiers/{slug}][%d] deleteNotifierOK %s", 200, payload)
}
...
func (o *DeleteNotifierBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notifiers/{slug}][%d] deleteNotifierBadRequest %s", 400, payload)
}
...
func (o *DeleteNotifierNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notifiers/{slug}][%d] deleteNotifierNotFound %s", 404, payload)
}
...
func (o *DeleteNotifierInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notifiers/{slug}][%d] deleteNotifierInternalServerError %s", 500, payload)
}
...
func (o *DeleteNotifierDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/notifiers/{slug}][%d] DeleteNotifier default %s", o._statusCode, payload)
}
