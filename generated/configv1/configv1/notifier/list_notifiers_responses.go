...
func (o *ListNotifiersOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/notifiers][%d] listNotifiersOK %s", 200, payload)
}
...
func (o *ListNotifiersInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notifiers][%d] listNotifiersInternalServerError %s", 500, payload)
}
...
func (o *ListNotifiersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notifiers][%d] ListNotifiers default %s", o._statusCode, payload)
}
