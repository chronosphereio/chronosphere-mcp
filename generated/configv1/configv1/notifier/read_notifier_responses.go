...
func (o *ReadNotifierOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/notifiers/{slug}][%d] readNotifierOK %s", 200, payload)
}
...
func (o *ReadNotifierNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notifiers/{slug}][%d] readNotifierNotFound %s", 404, payload)
}
...
func (o *ReadNotifierInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notifiers/{slug}][%d] readNotifierInternalServerError %s", 500, payload)
}
...
func (o *ReadNotifierDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/notifiers/{slug}][%d] ReadNotifier default %s", o._statusCode, payload)
}
