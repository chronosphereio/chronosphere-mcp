...
func (o *UpdateNotifierOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] updateNotifierOK %s", 200, payload)
}
...
func (o *UpdateNotifierBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] updateNotifierBadRequest %s", 400, payload)
}
...
func (o *UpdateNotifierNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] updateNotifierNotFound %s", 404, payload)
}
...
func (o *UpdateNotifierConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] updateNotifierConflict %s", 409, payload)
}
...
func (o *UpdateNotifierInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] updateNotifierInternalServerError %s", 500, payload)
}
...
func (o *UpdateNotifierDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/notifiers/{slug}][%d] UpdateNotifier default %s", o._statusCode, payload)
}
