...
func (o *CreateOtelMetricsIngestionOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/otel-metrics-ingestion][%d] createOtelMetricsIngestionOK %s", 200, payload)
}
...
func (o *CreateOtelMetricsIngestionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/otel-metrics-ingestion][%d] createOtelMetricsIngestionBadRequest %s", 400, payload)
}
...
func (o *CreateOtelMetricsIngestionConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/otel-metrics-ingestion][%d] createOtelMetricsIngestionConflict %s", 409, payload)
}
...
func (o *CreateOtelMetricsIngestionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/otel-metrics-ingestion][%d] createOtelMetricsIngestionInternalServerError %s", 500, payload)
}
...
func (o *CreateOtelMetricsIngestionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/otel-metrics-ingestion][%d] CreateOtelMetricsIngestion default %s", o._statusCode, payload)
}
