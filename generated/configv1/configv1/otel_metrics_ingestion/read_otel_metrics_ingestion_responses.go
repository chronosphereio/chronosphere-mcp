...
func (o *ReadOtelMetricsIngestionOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/otel-metrics-ingestion][%d] readOtelMetricsIngestionOK %s", 200, payload)
}
...
func (o *ReadOtelMetricsIngestionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/otel-metrics-ingestion][%d] readOtelMetricsIngestionNotFound %s", 404, payload)
}
...
func (o *ReadOtelMetricsIngestionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/otel-metrics-ingestion][%d] readOtelMetricsIngestionInternalServerError %s", 500, payload)
}
...
func (o *ReadOtelMetricsIngestionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/otel-metrics-ingestion][%d] ReadOtelMetricsIngestion default %s", o._statusCode, payload)
}
