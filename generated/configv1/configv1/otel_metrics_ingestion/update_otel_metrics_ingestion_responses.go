...
func (o *UpdateOtelMetricsIngestionOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/otel-metrics-ingestion][%d] updateOtelMetricsIngestionOK %s", 200, payload)
}
...
func (o *UpdateOtelMetricsIngestionBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/otel-metrics-ingestion][%d] updateOtelMetricsIngestionBadRequest %s", 400, payload)
}
...
func (o *UpdateOtelMetricsIngestionNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/otel-metrics-ingestion][%d] updateOtelMetricsIngestionNotFound %s", 404, payload)
}
...
func (o *UpdateOtelMetricsIngestionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/otel-metrics-ingestion][%d] updateOtelMetricsIngestionInternalServerError %s", 500, payload)
}
...
func (o *UpdateOtelMetricsIngestionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/otel-metrics-ingestion][%d] UpdateOtelMetricsIngestion default %s", o._statusCode, payload)
}
