...
func (o *CreateRecordingRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/recording-rules][%d] createRecordingRuleOK %s", 200, payload)
}
...
func (o *CreateRecordingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/recording-rules][%d] createRecordingRuleBadRequest %s", 400, payload)
}
...
func (o *CreateRecordingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/recording-rules][%d] createRecordingRuleConflict %s", 409, payload)
}
...
func (o *CreateRecordingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/recording-rules][%d] createRecordingRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateRecordingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/recording-rules][%d] CreateRecordingRule default %s", o._statusCode, payload)
}
