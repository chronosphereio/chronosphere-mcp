...
func (o *DeleteRecordingRuleOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/recording-rules/{slug}][%d] deleteRecordingRuleOK %s", 200, payload)
}
...
func (o *DeleteRecordingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/recording-rules/{slug}][%d] deleteRecordingRuleBadRequest %s", 400, payload)
}
...
func (o *DeleteRecordingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/recording-rules/{slug}][%d] deleteRecordingRuleNotFound %s", 404, payload)
}
...
func (o *DeleteRecordingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/recording-rules/{slug}][%d] deleteRecordingRuleInternalServerError %s", 500, payload)
}
...
func (o *DeleteRecordingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/recording-rules/{slug}][%d] DeleteRecordingRule default %s", o._statusCode, payload)
}
