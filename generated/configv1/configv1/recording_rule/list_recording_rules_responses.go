...
func (o *ListRecordingRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/recording-rules][%d] listRecordingRulesOK %s", 200, payload)
}
...
func (o *ListRecordingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/recording-rules][%d] listRecordingRulesInternalServerError %s", 500, payload)
}
...
func (o *ListRecordingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/recording-rules][%d] ListRecordingRules default %s", o._statusCode, payload)
}
