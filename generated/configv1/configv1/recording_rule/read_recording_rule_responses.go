...
func (o *ReadRecordingRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/recording-rules/{slug}][%d] readRecordingRuleOK %s", 200, payload)
}
...
func (o *ReadRecordingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/recording-rules/{slug}][%d] readRecordingRuleNotFound %s", 404, payload)
}
...
func (o *ReadRecordingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/recording-rules/{slug}][%d] readRecordingRuleInternalServerError %s", 500, payload)
}
...
func (o *ReadRecordingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/recording-rules/{slug}][%d] ReadRecordingRule default %s", o._statusCode, payload)
}
