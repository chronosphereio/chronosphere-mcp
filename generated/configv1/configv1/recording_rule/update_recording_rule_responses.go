...
func (o *UpdateRecordingRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] updateRecordingRuleOK %s", 200, payload)
}
...
func (o *UpdateRecordingRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] updateRecordingRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateRecordingRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] updateRecordingRuleNotFound %s", 404, payload)
}
...
func (o *UpdateRecordingRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] updateRecordingRuleConflict %s", 409, payload)
}
...
func (o *UpdateRecordingRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] updateRecordingRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateRecordingRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/recording-rules/{slug}][%d] UpdateRecordingRule default %s", o._statusCode, payload)
}
