...
func (o *CreateResourcePoolsOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/resource-pools][%d] createResourcePoolsOK %s", 200, payload)
}
...
func (o *CreateResourcePoolsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/resource-pools][%d] createResourcePoolsBadRequest %s", 400, payload)
}
...
func (o *CreateResourcePoolsConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/resource-pools][%d] createResourcePoolsConflict %s", 409, payload)
}
...
func (o *CreateResourcePoolsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/resource-pools][%d] createResourcePoolsInternalServerError %s", 500, payload)
}
...
func (o *CreateResourcePoolsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/resource-pools][%d] CreateResourcePools default %s", o._statusCode, payload)
}
