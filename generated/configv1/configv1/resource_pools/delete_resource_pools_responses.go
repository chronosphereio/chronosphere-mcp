...
func (o *DeleteResourcePoolsOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/resource-pools][%d] deleteResourcePoolsOK %s", 200, payload)
}
...
func (o *DeleteResourcePoolsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/resource-pools][%d] deleteResourcePoolsBadRequest %s", 400, payload)
}
...
func (o *DeleteResourcePoolsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/resource-pools][%d] deleteResourcePoolsNotFound %s", 404, payload)
}
...
func (o *DeleteResourcePoolsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/resource-pools][%d] deleteResourcePoolsInternalServerError %s", 500, payload)
}
...
func (o *DeleteResourcePoolsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/resource-pools][%d] DeleteResourcePools default %s", o._statusCode, payload)
}
