...
func (o *ReadResourcePoolsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/resource-pools][%d] readResourcePoolsOK %s", 200, payload)
}
...
func (o *ReadResourcePoolsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/resource-pools][%d] readResourcePoolsNotFound %s", 404, payload)
}
...
func (o *ReadResourcePoolsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/resource-pools][%d] readResourcePoolsInternalServerError %s", 500, payload)
}
...
func (o *ReadResourcePoolsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/resource-pools][%d] ReadResourcePools default %s", o._statusCode, payload)
}
