...
func (o *UpdateResourcePoolsOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/resource-pools][%d] updateResourcePoolsOK %s", 200, payload)
}
...
func (o *UpdateResourcePoolsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/resource-pools][%d] updateResourcePoolsBadRequest %s", 400, payload)
}
...
func (o *UpdateResourcePoolsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/resource-pools][%d] updateResourcePoolsNotFound %s", 404, payload)
}
...
func (o *UpdateResourcePoolsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/resource-pools][%d] updateResourcePoolsInternalServerError %s", 500, payload)
}
...
func (o *UpdateResourcePoolsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/resource-pools][%d] UpdateResourcePools default %s", o._statusCode, payload)
}
