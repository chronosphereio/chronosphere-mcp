...
func (o *CreateRollupRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/rollup-rules][%d] createRollupRuleOK %s", 200, payload)
}
...
func (o *CreateRollupRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/rollup-rules][%d] createRollupRuleBadRequest %s", 400, payload)
}
...
func (o *CreateRollupRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/rollup-rules][%d] createRollupRuleConflict %s", 409, payload)
}
...
func (o *CreateRollupRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/rollup-rules][%d] createRollupRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateRollupRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/rollup-rules][%d] CreateRollupRule default %s", o._statusCode, payload)
}
