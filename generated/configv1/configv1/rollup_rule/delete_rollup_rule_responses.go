...
func (o *DeleteRollupRuleOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/rollup-rules/{slug}][%d] deleteRollupRuleOK %s", 200, payload)
}
...
func (o *DeleteRollupRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/rollup-rules/{slug}][%d] deleteRollupRuleBadRequest %s", 400, payload)
}
...
func (o *DeleteRollupRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/rollup-rules/{slug}][%d] deleteRollupRuleNotFound %s", 404, payload)
}
...
func (o *DeleteRollupRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/rollup-rules/{slug}][%d] deleteRollupRuleInternalServerError %s", 500, payload)
}
...
func (o *DeleteRollupRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/rollup-rules/{slug}][%d] DeleteRollupRule default %s", o._statusCode, payload)
}
