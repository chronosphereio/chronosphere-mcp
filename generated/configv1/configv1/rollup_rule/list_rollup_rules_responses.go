...
func (o *ListRollupRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules][%d] listRollupRulesOK %s", 200, payload)
}
...
func (o *ListRollupRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules][%d] listRollupRulesInternalServerError %s", 500, payload)
}
...
func (o *ListRollupRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules][%d] ListRollupRules default %s", o._statusCode, payload)
}
