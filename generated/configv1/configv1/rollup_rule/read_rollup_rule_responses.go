...
func (o *ReadRollupRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules/{slug}][%d] readRollupRuleOK %s", 200, payload)
}
...
func (o *ReadRollupRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules/{slug}][%d] readRollupRuleNotFound %s", 404, payload)
}
...
func (o *ReadRollupRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules/{slug}][%d] readRollupRuleInternalServerError %s", 500, payload)
}
...
func (o *ReadRollupRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/rollup-rules/{slug}][%d] ReadRollupRule default %s", o._statusCode, payload)
}
