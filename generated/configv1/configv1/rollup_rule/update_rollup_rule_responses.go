...
func (o *UpdateRollupRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] updateRollupRuleOK %s", 200, payload)
}
...
func (o *UpdateRollupRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] updateRollupRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateRollupRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] updateRollupRuleNotFound %s", 404, payload)
}
...
func (o *UpdateRollupRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] updateRollupRuleConflict %s", 409, payload)
}
...
func (o *UpdateRollupRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] updateRollupRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateRollupRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/rollup-rules/{slug}][%d] UpdateRollupRule default %s", o._statusCode, payload)
}
