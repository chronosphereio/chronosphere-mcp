...
func (o *ListSLOsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] listSLOsOK %s", 200, payload)
}
...
func (o *ListSLOsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] listSLOsInternalServerError %s", 500, payload)
}
...
func (o *ListSLOsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] ListSLOs default %s", o._statusCode, payload)
}
