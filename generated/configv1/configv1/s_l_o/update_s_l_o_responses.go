...
func (o *UpdateSLOOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSLOOK %s", 200, payload)
}
...
func (o *UpdateSLOBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSLOBadRequest %s", 400, payload)
}
...
func (o *UpdateSLONotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSLONotFound %s", 404, payload)
}
...
func (o *UpdateSLOConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSLOConflict %s", 409, payload)
}
...
func (o *UpdateSLOInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSLOInternalServerError %s", 500, payload)
}
...
func (o *UpdateSLODefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] UpdateSLO default %s", o._statusCode, payload)
}
