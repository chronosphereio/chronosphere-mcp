...
func (o *ReadServiceOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/services/{slug}][%d] readServiceOK %s", 200, payload)
}
...
func (o *ReadServiceNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/services/{slug}][%d] readServiceNotFound %s", 404, payload)
}
...
func (o *ReadServiceInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/services/{slug}][%d] readServiceInternalServerError %s", 500, payload)
}
...
func (o *ReadServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/services/{slug}][%d] ReadService default %s", o._statusCode, payload)
}
