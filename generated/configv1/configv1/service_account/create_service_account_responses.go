...
func (o *CreateServiceAccountOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/service-accounts][%d] createServiceAccountOK %s", 200, payload)
}
...
func (o *CreateServiceAccountBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/service-accounts][%d] createServiceAccountBadRequest %s", 400, payload)
}
...
func (o *CreateServiceAccountConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/service-accounts][%d] createServiceAccountConflict %s", 409, payload)
}
...
func (o *CreateServiceAccountInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/service-accounts][%d] createServiceAccountInternalServerError %s", 500, payload)
}
...
func (o *CreateServiceAccountDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/service-accounts][%d] CreateServiceAccount default %s", o._statusCode, payload)
}
