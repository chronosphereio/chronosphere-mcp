...
func (o *DeleteServiceAccountOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/service-accounts/{slug}][%d] deleteServiceAccountOK %s", 200, payload)
}
...
func (o *DeleteServiceAccountBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/service-accounts/{slug}][%d] deleteServiceAccountBadRequest %s", 400, payload)
}
...
func (o *DeleteServiceAccountNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/service-accounts/{slug}][%d] deleteServiceAccountNotFound %s", 404, payload)
}
...
func (o *DeleteServiceAccountInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/service-accounts/{slug}][%d] deleteServiceAccountInternalServerError %s", 500, payload)
}
...
func (o *DeleteServiceAccountDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/service-accounts/{slug}][%d] DeleteServiceAccount default %s", o._statusCode, payload)
}
