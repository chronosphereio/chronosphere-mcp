...
func (o *ListServiceAccountsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/service-accounts][%d] listServiceAccountsOK %s", 200, payload)
}
...
func (o *ListServiceAccountsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/service-accounts][%d] listServiceAccountsInternalServerError %s", 500, payload)
}
...
func (o *ListServiceAccountsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/service-accounts][%d] ListServiceAccounts default %s", o._statusCode, payload)
}
