...
func (o *ReadServiceAccountOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/service-accounts/{slug}][%d] readServiceAccountOK %s", 200, payload)
}
...
func (o *ReadServiceAccountNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/service-accounts/{slug}][%d] readServiceAccountNotFound %s", 404, payload)
}
...
func (o *ReadServiceAccountInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/service-accounts/{slug}][%d] readServiceAccountInternalServerError %s", 500, payload)
}
...
func (o *ReadServiceAccountDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/service-accounts/{slug}][%d] ReadServiceAccount default %s", o._statusCode, payload)
}
