...
func (o *CreateTeamOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/teams][%d] createTeamOK %s", 200, payload)
}
...
func (o *CreateTeamBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/teams][%d] createTeamBadRequest %s", 400, payload)
}
...
func (o *CreateTeamConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/teams][%d] createTeamConflict %s", 409, payload)
}
...
func (o *CreateTeamInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/teams][%d] createTeamInternalServerError %s", 500, payload)
}
...
func (o *CreateTeamDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/teams][%d] CreateTeam default %s", o._statusCode, payload)
}
