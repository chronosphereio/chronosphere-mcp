...
func (o *DeleteTeamOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/teams/{slug}][%d] deleteTeamOK %s", 200, payload)
}
...
func (o *DeleteTeamBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/teams/{slug}][%d] deleteTeamBadRequest %s", 400, payload)
}
...
func (o *DeleteTeamNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/teams/{slug}][%d] deleteTeamNotFound %s", 404, payload)
}
...
func (o *DeleteTeamInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/teams/{slug}][%d] deleteTeamInternalServerError %s", 500, payload)
}
...
func (o *DeleteTeamDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/teams/{slug}][%d] DeleteTeam default %s", o._statusCode, payload)
}
