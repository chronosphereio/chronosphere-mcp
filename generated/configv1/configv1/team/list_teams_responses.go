...
func (o *ListTeamsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/teams][%d] listTeamsOK %s", 200, payload)
}
...
func (o *ListTeamsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/teams][%d] listTeamsInternalServerError %s", 500, payload)
}
...
func (o *ListTeamsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/teams][%d] ListTeams default %s", o._statusCode, payload)
}
