...
func (o *ReadTeamOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/teams/{slug}][%d] readTeamOK %s", 200, payload)
}
...
func (o *ReadTeamNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/teams/{slug}][%d] readTeamNotFound %s", 404, payload)
}
...
func (o *ReadTeamInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/teams/{slug}][%d] readTeamInternalServerError %s", 500, payload)
}
...
func (o *ReadTeamDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/teams/{slug}][%d] ReadTeam default %s", o._statusCode, payload)
}
