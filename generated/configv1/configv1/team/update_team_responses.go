...
func (o *UpdateTeamOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] updateTeamOK %s", 200, payload)
}
...
func (o *UpdateTeamBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] updateTeamBadRequest %s", 400, payload)
}
...
func (o *UpdateTeamNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] updateTeamNotFound %s", 404, payload)
}
...
func (o *UpdateTeamConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] updateTeamConflict %s", 409, payload)
}
...
func (o *UpdateTeamInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] updateTeamInternalServerError %s", 500, payload)
}
...
func (o *UpdateTeamDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/teams/{slug}][%d] UpdateTeam default %s", o._statusCode, payload)
}
