...
func (o *CreateTraceBehaviorOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorOK %s", 200, payload)
}
...
func (o *CreateTraceBehaviorBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorBadRequest %s", 400, payload)
}
...
func (o *CreateTraceBehaviorConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorConflict %s", 409, payload)
}
...
func (o *CreateTraceBehaviorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorInternalServerError %s", 500, payload)
}
...
func (o *CreateTraceBehaviorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] CreateTraceBehavior default %s", o._statusCode, payload)
}
