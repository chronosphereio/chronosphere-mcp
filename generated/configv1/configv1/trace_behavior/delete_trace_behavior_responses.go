...
func (o *DeleteTraceBehaviorOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorOK %s", 200, payload)
}
...
func (o *DeleteTraceBehaviorBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorBadRequest %s", 400, payload)
}
...
func (o *DeleteTraceBehaviorNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorNotFound %s", 404, payload)
}
...
func (o *DeleteTraceBehaviorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorInternalServerError %s", 500, payload)
}
...
func (o *DeleteTraceBehaviorDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behaviors/{slug}][%d] DeleteTraceBehavior default %s", o._statusCode, payload)
}
