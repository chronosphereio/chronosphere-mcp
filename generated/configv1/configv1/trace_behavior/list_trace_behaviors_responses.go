...
func (o *ListTraceBehaviorsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] listTraceBehaviorsOK %s", 200, payload)
}
...
func (o *ListTraceBehaviorsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] listTraceBehaviorsInternalServerError %s", 500, payload)
}
...
func (o *ListTraceBehaviorsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] ListTraceBehaviors default %s", o._statusCode, payload)
}
