...
func (o *CreateTraceBehaviorConfigOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/trace-behavior-config][%d] createTraceBehaviorConfigOK %s", 200, payload)
}
...
func (o *CreateTraceBehaviorConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behavior-config][%d] createTraceBehaviorConfigBadRequest %s", 400, payload)
}
...
func (o *CreateTraceBehaviorConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behavior-config][%d] createTraceBehaviorConfigConflict %s", 409, payload)
}
...
func (o *CreateTraceBehaviorConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behavior-config][%d] createTraceBehaviorConfigInternalServerError %s", 500, payload)
}
...
func (o *CreateTraceBehaviorConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-behavior-config][%d] CreateTraceBehaviorConfig default %s", o._statusCode, payload)
}
