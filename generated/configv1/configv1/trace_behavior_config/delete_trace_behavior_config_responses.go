...
func (o *DeleteTraceBehaviorConfigOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behavior-config][%d] deleteTraceBehaviorConfigOK %s", 200, payload)
}
...
func (o *DeleteTraceBehaviorConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behavior-config][%d] deleteTraceBehaviorConfigBadRequest %s", 400, payload)
}
...
func (o *DeleteTraceBehaviorConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behavior-config][%d] deleteTraceBehaviorConfigNotFound %s", 404, payload)
}
...
func (o *DeleteTraceBehaviorConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behavior-config][%d] deleteTraceBehaviorConfigInternalServerError %s", 500, payload)
}
...
func (o *DeleteTraceBehaviorConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-behavior-config][%d] DeleteTraceBehaviorConfig default %s", o._statusCode, payload)
}
