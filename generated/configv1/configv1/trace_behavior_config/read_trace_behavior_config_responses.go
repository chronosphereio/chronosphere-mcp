...
func (o *ReadTraceBehaviorConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-behavior-config][%d] readTraceBehaviorConfigOK %s", 200, payload)
}
...
func (o *ReadTraceBehaviorConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-behavior-config][%d] readTraceBehaviorConfigNotFound %s", 404, payload)
}
...
func (o *ReadTraceBehaviorConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-behavior-config][%d] readTraceBehaviorConfigInternalServerError %s", 500, payload)
}
...
func (o *ReadTraceBehaviorConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-behavior-config][%d] ReadTraceBehaviorConfig default %s", o._statusCode, payload)
}
