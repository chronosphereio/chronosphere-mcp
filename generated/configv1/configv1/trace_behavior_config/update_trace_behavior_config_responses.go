...
func (o *UpdateTraceBehaviorConfigOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/trace-behavior-config][%d] updateTraceBehaviorConfigOK %s", 200, payload)
}
...
func (o *UpdateTraceBehaviorConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-behavior-config][%d] updateTraceBehaviorConfigBadRequest %s", 400, payload)
}
...
func (o *UpdateTraceBehaviorConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-behavior-config][%d] updateTraceBehaviorConfigNotFound %s", 404, payload)
}
...
func (o *UpdateTraceBehaviorConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-behavior-config][%d] updateTraceBehaviorConfigInternalServerError %s", 500, payload)
}
...
func (o *UpdateTraceBehaviorConfigDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-behavior-config][%d] UpdateTraceBehaviorConfig default %s", o._statusCode, payload)
}
