...
func (o *CreateTraceJaegerRemoteSamplingStrategyOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyOK %s", 200, payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyBadRequest %s", 400, payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyConflict %s", 409, payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyInternalServerError %s", 500, payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] CreateTraceJaegerRemoteSamplingStrategy default %s", o._statusCode, payload)
}
