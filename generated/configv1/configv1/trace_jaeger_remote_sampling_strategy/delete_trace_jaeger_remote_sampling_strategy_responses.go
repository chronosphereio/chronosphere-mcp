...
func (o *DeleteTraceJaegerRemoteSamplingStrategyOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyOK %s", 200, payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyBadRequest %s", 400, payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyNotFound %s", 404, payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyInternalServerError %s", 500, payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] DeleteTraceJaegerRemoteSamplingStrategy default %s", o._statusCode, payload)
}
