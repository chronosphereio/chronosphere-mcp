...
func (o *ListTraceJaegerRemoteSamplingStrategiesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] listTraceJaegerRemoteSamplingStrategiesOK %s", 200, payload)
}
...
func (o *ListTraceJaegerRemoteSamplingStrategiesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] listTraceJaegerRemoteSamplingStrategiesInternalServerError %s", 500, payload)
}
...
func (o *ListTraceJaegerRemoteSamplingStrategiesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] ListTraceJaegerRemoteSamplingStrategies default %s", o._statusCode, payload)
}
