...
func (o *ReadTraceJaegerRemoteSamplingStrategyOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] readTraceJaegerRemoteSamplingStrategyOK %s", 200, payload)
}
...
func (o *ReadTraceJaegerRemoteSamplingStrategyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] readTraceJaegerRemoteSamplingStrategyNotFound %s", 404, payload)
}
...
func (o *ReadTraceJaegerRemoteSamplingStrategyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] readTraceJaegerRemoteSamplingStrategyInternalServerError %s", 500, payload)
}
...
func (o *ReadTraceJaegerRemoteSamplingStrategyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] ReadTraceJaegerRemoteSamplingStrategy default %s", o._statusCode, payload)
}
