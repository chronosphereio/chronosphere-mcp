...
func (o *CreateTraceMetricsRuleOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleOK %s", 200, payload)
}
...
func (o *CreateTraceMetricsRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleBadRequest %s", 400, payload)
}
...
func (o *CreateTraceMetricsRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleConflict %s", 409, payload)
}
...
func (o *CreateTraceMetricsRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleInternalServerError %s", 500, payload)
}
...
func (o *CreateTraceMetricsRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] CreateTraceMetricsRule default %s", o._statusCode, payload)
}
