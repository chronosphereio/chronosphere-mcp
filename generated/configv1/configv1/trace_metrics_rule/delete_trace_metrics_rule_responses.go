...
func (o *DeleteTraceMetricsRuleOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/trace-metrics-rules/{slug}][%d] deleteTraceMetricsRuleOK %s", 200, payload)
}
...
func (o *DeleteTraceMetricsRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-metrics-rules/{slug}][%d] deleteTraceMetricsRuleBadRequest %s", 400, payload)
}
...
func (o *DeleteTraceMetricsRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-metrics-rules/{slug}][%d] deleteTraceMetricsRuleNotFound %s", 404, payload)
}
...
func (o *DeleteTraceMetricsRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-metrics-rules/{slug}][%d] deleteTraceMetricsRuleInternalServerError %s", 500, payload)
}
...
func (o *DeleteTraceMetricsRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-metrics-rules/{slug}][%d] DeleteTraceMetricsRule default %s", o._statusCode, payload)
}
