...
func (o *ListTraceMetricsRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-metrics-rules][%d] listTraceMetricsRulesOK %s", 200, payload)
}
...
func (o *ListTraceMetricsRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-metrics-rules][%d] listTraceMetricsRulesInternalServerError %s", 500, payload)
}
...
func (o *ListTraceMetricsRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-metrics-rules][%d] ListTraceMetricsRules default %s", o._statusCode, payload)
}
