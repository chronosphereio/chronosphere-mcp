...
func (o *UpdateTraceMetricsRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] updateTraceMetricsRuleOK %s", 200, payload)
}
...
func (o *UpdateTraceMetricsRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] updateTraceMetricsRuleBadRequest %s", 400, payload)
}
...
func (o *UpdateTraceMetricsRuleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] updateTraceMetricsRuleNotFound %s", 404, payload)
}
...
func (o *UpdateTraceMetricsRuleConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] updateTraceMetricsRuleConflict %s", 409, payload)
}
...
func (o *UpdateTraceMetricsRuleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] updateTraceMetricsRuleInternalServerError %s", 500, payload)
}
...
func (o *UpdateTraceMetricsRuleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/v1/config/trace-metrics-rules/{slug}][%d] UpdateTraceMetricsRule default %s", o._statusCode, payload)
}
