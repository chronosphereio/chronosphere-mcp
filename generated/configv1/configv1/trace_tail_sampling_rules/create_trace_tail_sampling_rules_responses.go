...
func (o *CreateTraceTailSamplingRulesOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/config/trace-tail-sampling-rules][%d] createTraceTailSamplingRulesOK %s", 200, payload)
}
...
func (o *CreateTraceTailSamplingRulesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-tail-sampling-rules][%d] createTraceTailSamplingRulesBadRequest %s", 400, payload)
}
...
func (o *CreateTraceTailSamplingRulesConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-tail-sampling-rules][%d] createTraceTailSamplingRulesConflict %s", 409, payload)
}
...
func (o *CreateTraceTailSamplingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-tail-sampling-rules][%d] createTraceTailSamplingRulesInternalServerError %s", 500, payload)
}
...
func (o *CreateTraceTailSamplingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/config/trace-tail-sampling-rules][%d] CreateTraceTailSamplingRules default %s", o._statusCode, payload)
}
