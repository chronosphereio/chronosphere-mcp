...
func (o *DeleteTraceTailSamplingRulesOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesOK %s", 200, payload)
}
...
func (o *DeleteTraceTailSamplingRulesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesBadRequest %s", 400, payload)
}
...
func (o *DeleteTraceTailSamplingRulesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesNotFound %s", 404, payload)
}
...
func (o *DeleteTraceTailSamplingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesInternalServerError %s", 500, payload)
}
...
func (o *DeleteTraceTailSamplingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] DeleteTraceTailSamplingRules default %s", o._statusCode, payload)
}
