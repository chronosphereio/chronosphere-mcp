...
func (o *ReadTraceTailSamplingRulesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/config/trace-tail-sampling-rules][%d] readTraceTailSamplingRulesOK %s", 200, payload)
}
...
func (o *ReadTraceTailSamplingRulesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-tail-sampling-rules][%d] readTraceTailSamplingRulesNotFound %s", 404, payload)
}
...
func (o *ReadTraceTailSamplingRulesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-tail-sampling-rules][%d] readTraceTailSamplingRulesInternalServerError %s", 500, payload)
}
...
func (o *ReadTraceTailSamplingRulesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/config/trace-tail-sampling-rules][%d] ReadTraceTailSamplingRules default %s", o._statusCode, payload)
}
