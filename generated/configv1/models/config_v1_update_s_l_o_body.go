...
// ConfigV1UpdateSLOBody config v1 update s l o body
//
...
// Validate validates this config v1 update s l o body
...
// ContextValidate validate this config v1 update s l o body based on the context it is used
