...
// Configv1CreateSLOResponse configv1 create s l o response
//
...
// Validate validates this configv1 create s l o response
...
// ContextValidate validate this configv1 create s l o response based on the context it is used
