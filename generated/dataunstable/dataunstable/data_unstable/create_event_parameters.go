...
type CreateEventParams struct {
	...
	// Body.
	Body *models.DataunstableCreateEventRequest
...
func (o *CreateEventParams) WithBody(body *models.DataunstableCreateEventRequest) *CreateEventParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create event params
func (o *CreateEventParams) SetBody(body *models.DataunstableCreateEventRequest) {
	o.Body = body
}
