...
type ClientService interface {
	AnalyzeAlerts(params *AnalyzeAlertsParams, opts ...ClientOption) (*AnalyzeAlertsOK, error)
...
*/
func (a *Client) AnalyzeAlerts(params *AnalyzeAlertsParams, opts ...ClientOption) (*AnalyzeAlertsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAnalyzeAlertsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "AnalyzeAlerts",
		Method:             "POST",
		PathPattern:        "/api/unstable/data/alerts:analyze",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AnalyzeAlertsReader{formats: a.formats},
	...
	success, ok := result.(*AnalyzeAlertsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*AnalyzeAlertsDefault)
