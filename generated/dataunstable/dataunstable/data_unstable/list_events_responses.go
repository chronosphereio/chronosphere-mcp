...
type ListEventsOK struct {
	Payload *models.DataunstableListEventsResponse
}
...
func (o *ListEventsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/unstable/data/events][%d] listEventsOK %s", 200, payload)
}
...
func (o *ListEventsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/unstable/data/events][%d] ListEvents default %s", o._statusCode, payload)
}
...
func (o *ListEventsDefault) GetPayload() *models.GooglerpcStatus {
	return o.Payload
}
