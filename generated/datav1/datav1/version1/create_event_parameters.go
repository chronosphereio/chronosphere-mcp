...
type CreateEventParams struct {
	...
	// Body.
	Body *models.Datav1CreateEventRequest
...
func (o *CreateEventParams) WithBody(body *models.Datav1CreateEventRequest) *CreateEventParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create event params
func (o *CreateEventParams) SetBody(body *models.Datav1CreateEventRequest) {
	o.Body = body
}
