...
type ListEventsOK struct {
	Payload *models.Datav1ListEventsResponse
}
...
func (o *ListEventsOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/data/events][%d] listEventsOK %s", 200, payload)
}
...
func (o *ListEventsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/data/events][%d] ListEvents default %s", o._statusCode, payload)
}
