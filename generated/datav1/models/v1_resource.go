...
func (m *V1Resource) validateAttributes(formats strfmt.Registry) error {
...
func (m *V1Resource) validateEntityRefs(formats strfmt.Registry) error {
...
func (m *V1Resource) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1Resource) contextValidateEntityRefs(ctx context.Context, formats strfmt.Registry) error {
