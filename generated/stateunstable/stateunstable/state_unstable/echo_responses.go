...
func (o *EchoOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/unstable/state/echo][%d] echoOK %s", 200, payload)
}
...
func (o *EchoDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/unstable/state/echo][%d] Echo default %s", o._statusCode, payload)
}
