...
func (o *ListMonitorStatusesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/unstable/state/monitors-statuses][%d] listMonitorStatusesOK %s", 200, payload)
}
...
func (o *ListMonitorStatusesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/unstable/state/monitors-statuses][%d] ListMonitorStatuses default %s", o._statusCode, payload)
}
