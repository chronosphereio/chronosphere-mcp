...
package metric_usages_by_metric_name
...
func (o *ListMetricUsagesByMetricNameOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/state/metric-usages-by-metric-name][%d] listMetricUsagesByMetricNameOK %s", 200, payload)
}
...
func (o *ListMetricUsagesByMetricNameDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/state/metric-usages-by-metric-name][%d] ListMetricUsagesByMetricName default %s", o._statusCode, payload)
}
