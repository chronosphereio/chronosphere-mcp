...
func (o *ListMetricUsagesByLabelNameOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/state/metric-usages-by-label-name][%d] listMetricUsagesByLabelNameOK %s", 200, payload)
}
...
func (o *ListMetricUsagesByLabelNameDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/state/metric-usages-by-label-name][%d] ListMetricUsagesByLabelName default %s", o._statusCode, payload)
}
...
func (o *ListMetricUsagesByLabelNameDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
