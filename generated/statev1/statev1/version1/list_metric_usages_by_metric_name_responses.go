...
import (
	...
	"github.com/chronosphereio/chronosphere-mcp/generated/statev1/models"
)
...
func (o *ListMetricUsagesByMetricNameOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/state/metric-usages-by-metric-name][%d] listMetricUsagesByMetricNameOK %s", 200, payload)
}
...
func (o *ListMetricUsagesByMetricNameDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/state/metric-usages-by-metric-name][%d] ListMetricUsagesByMetricName default %s", o._statusCode, payload)
}
...
func (o *ListMetricUsagesByMetricNameDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
