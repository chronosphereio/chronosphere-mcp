...
func (o *ListRuleEvaluationsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/state/rule-evaluations][%d] listRuleEvaluationsOK %s", 200, payload)
}
...
func (o *ListRuleEvaluationsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/state/rule-evaluations][%d] ListRuleEvaluations default %s", o._statusCode, payload)
}
...
func (o *ListRuleEvaluationsDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
